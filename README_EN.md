...
## Update Notes (2024-06-19)

* UI Improvements
  - Added double-click on top bar for window resizing
  - Optimized responsive layout when resizing windows
  - Changed global font format and advanced font format to tabs switching form
  - Improved tab bar label text display
  - Added confirmation prompt when closing the program

* Image Import Enhancements
  - Support for dragging files/folders, selecting files (multiple) and selecting folders
  - Set import image and folder functions as independent buttons
  - Fixed issue where dragging a single image file would import the entire folder
  - Modified image import method to create a new workspace for each import
  - Fixed potential security issues when importing images

* Workspace Image Management
  - Added function to delete workspace images, supporting Ctrl+multi-select and right-click delete
  - Added function to translate selected images after multi-selection

* Translation Feature Enhancements
  - Added function to test if translation source is available
  - Optimized display of translation test area
  - Added display of translation test results and time used

* Internationalization
  - Adapted interface according to the system's current supported language
  - Fixed translation issues with the open file button
