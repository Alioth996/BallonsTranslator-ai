...
from utils.proxy_utils import normalize_proxy_url, create_httpx_transport
...
class DeepLX(BaseTranslator):
    ...
    def _create_proxy_mounts(self, proxy_str: Optional[str]) -> Optional[Dict]:
        ...
        # 规范化代理URL
        normalized_proxy = normalize_proxy_url(proxy_str)
        return create_httpx_transport(normalized_proxy)
